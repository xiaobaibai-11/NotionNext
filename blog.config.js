...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是淘圣, 爱分享有趣、有料的资源和知识，希望你喜欢我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '淘圣', // 您的昵称 例如 tangly1024
  ...
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/taosshare', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-RW67JM1D7H', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
